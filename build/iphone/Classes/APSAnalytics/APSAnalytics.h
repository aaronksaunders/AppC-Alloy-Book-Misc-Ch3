 ...
 * to send analytic data that can be viewed on the Cross_PlatformTemplate Dashboard.
 *
 * For information on getting started with Cross_PlatformTemplate Platform Services,
