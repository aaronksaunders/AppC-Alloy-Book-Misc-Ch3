...
// in simulator we redefine to format for Cross_PlatformTemplate Developer console
...
{\
	NSString * exceptionName = [@"org.cross_platformtemplate." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cross_platformtemplate";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICross_PlatformTemplateNativeItemNone = -1, 
	UICross_PlatformTemplateNativeItemSpinner = -2,
	UICross_PlatformTemplateNativeItemProgressBar = -3,
	
	UICross_PlatformTemplateNativeItemSlider = -4,
	UICross_PlatformTemplateNativeItemSwitch = -5,
	UICross_PlatformTemplateNativeItemMultiButton = -6,
	UICross_PlatformTemplateNativeItemSegmented = -7,
	
	UICross_PlatformTemplateNativeItemTextView = -8,
	UICross_PlatformTemplateNativeItemTextField = -9,
	UICross_PlatformTemplateNativeItemSearchBar = -10,
	
	UICross_PlatformTemplateNativeItemPicker = -11,
	UICross_PlatformTemplateNativeItemDatePicker = -12,
	
	UICross_PlatformTemplateNativeItemInfoLight = -13,
	UICross_PlatformTemplateNativeItemInfoDark = -14,
	
	UICross_PlatformTemplateNativeItemDisclosure = -15,
	
	UICross_PlatformTemplateNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Cross_PlatformTemplate instances of
