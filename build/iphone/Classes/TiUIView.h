...
/**
 Base class for all Cross_PlatformTemplate views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Cross_PlatformTemplate view hierarchy (such as wrapped iOS UIViews) was touched.
