...
//Rare exceptions to indicate a bug in the _cross_platformtemplate code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Cross_PlatformTemplate proxies.
 */
