...
/**
 The base class for all Cross_PlatformTemplate modules
 */
...
/**
 Cross_PlatformTemplate Platform calls this method on startup.
 */
-(void)startup;

/**
 Cross_PlatformTemplate Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Cross_PlatformTemplate Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Cross_PlatformTemplate Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Cross_PlatformTemplate Platform calls this method on resume.
 @param sender The sender of the event.
 */
