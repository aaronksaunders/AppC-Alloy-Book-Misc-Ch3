...
//@interface Cross_PlatformTemplateObject : NSObject
//@end

@interface Cross_PlatformTemplateObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Cross_PlatformTemplateObject class]])
		{
			for (NSString *key in [[(Cross_PlatformTemplateObject*)o modules] allKeys])
			{
