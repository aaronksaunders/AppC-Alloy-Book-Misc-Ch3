...
@interface Cross_PlatformTemplateObject : KrollCoverageObject {
#else
@interface Cross_PlatformTemplateObject : KrollObject {
#endif
@private
...
extern NSString * Cross_PlatformTemplate$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Cross_PlatformTemplateObject *_cross_platformtemplate;
    KrollObject* console;
	BOOL shutdown;
